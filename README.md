...
* While loops were trickier, but I decided to use lists. A while loop would run its body (an expression) while the condition remains true, and then add the result to a list. Then it would return the list. Syntax: `(condition)::body`.
