...
public interface ExpressionVisitor<R> {
    ...
    R visitRepeatExpression(RepeatExpression expr);
    R visitNumericBinaryExpression(NumericBinaryExpression expr);
    R visitNumericUnaryExpression(NumericUnaryExpression expr);
}
